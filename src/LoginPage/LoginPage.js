    ...
    return(
        ...
        <div  className=' bg-[#F6EBDA] '>
            ...
            <form>
                ...
                <div className="flex flex-col items-center mt-5 "><button class="font-bold w-6/12 h-10 px-5 m-2 text-[#F6EBDA] transition-colors duration-150 bg-[#433416] rounded-lg focus:shadow-outline hover:bg-[#433416] title">Submit</button></div>
